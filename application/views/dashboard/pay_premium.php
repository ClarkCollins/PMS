                                ...
                                <div class="col-lg-10">
                                    <form action="<?php echo site_url() ?>/make_payment" enctype="multipart/form-data"  method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly min="50" step=".001" value="<?php echo "R ".$meg5; ?>" class="form-control" placeholder="Primium amount" name="premium_amt">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if ($meg1 == $value->ClientID && $meg6 > $value->total): ?>
                                                <div class="form-group">
                                                    ...
                                                    <input readonly  type="text" value="<?php $cal=$meg6 - $value->total + $meg5;  echo "R ".$cal.".00"; ?>" class="form-control" name="amount_due">
                                                </div>
                                        <?php else: ?>
                                        <div class="form-group">
                                                    <label>Amount Due:</label>
                                                    <input readonly  type="text" value="<?php echo "R ".$meg5; ?>" class="form-control" name="amount_due">
                                                </div>
                                            <?php endif ?>
                                        <?php } ?>
                                        <div class="form-group">
