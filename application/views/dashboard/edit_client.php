        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-pencil-square-o fa-fw"></i> Update Client Form
                </div>
                        ...
                        <div class="col-lg-10">
                            <form action="<?php echo site_url() ?>/update" enctype="multipart/form-data"  method="post" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="<?php echo $meg5 ?>" name="DOB" placeholder="date of birth" max="<?php $date = date('Y-m-d');
echo $date ?>"  required>
                                </div>
                                <div class="form-group">
                                    <label>Gender:</label>
